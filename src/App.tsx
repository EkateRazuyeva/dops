...
export const moneyFilter = (money: MoneyType[], filterKey:BanknotsType): Array<MoneyType> => {
   if(filterKey==='All') return money //если пришел filter со значением 'All', то возвращаем все банкноты
    return money.filter(el=>el.banknotes===filterKey)//return money.filter... ну да, придется фильтровать
}
